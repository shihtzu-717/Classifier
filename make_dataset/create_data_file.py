...
crop_data_list = glob('../../nasdata/crop_trainset/**/*.jpg', recursive=True) + glob('../../nasdata/crop_trainset/**/*.png', recursive=True)
...
with open('../results/230801_crop_img/train.txt', 'w') as f:
    for i in train_set:
        f.write(i+'\n')
        
with open('../results/230801_crop_img/valid.txt', 'w') as f:
    for i in valid_set:
        f.write(i+'\n')
