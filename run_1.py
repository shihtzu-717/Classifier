...
soft_label_ratio = [0.95, 0.9, 0.8, 0.7]
...
base = """CUDA_VISIBLE_DEVICES=1 python main.py \
            ...
            --data_path /home/daree/nas/Classification_Model/ambclass/2nd_data \
            --eval_data_path /home/daree/nas/Classification_Model/ambclass/2nd_data \
            ...
            for shift in use_shift:
                for target_ratio in target_label_ratio:
                    for soft_ratio in soft_label_ratio:
                        name = f'pad_{pad}_padsize_{pad_size:.1f}_box_{bbox}_shift_{shift}_sratio_{soft_ratio}_tratio_{target_ratio}'
