...
base = """CUDA_VISIBLE_DEVICES=0 python main.py \
            ...
            --train_txt_path results/230822_dataset_2/train+GAN+detection+seoul_pos.txt \
...
name1 = f'pad_PIXEL_padsize_100.0_box_False_shift_True_sratio_1.0_tratio_1.0_nbclss_2_detection+seoul-pos+softlabel-0.7'
os.system(f"""{base} \
            --padding PIXEL \
            --padding_size 100.0 \
            --use_bbox False \
...
name1 = f'pad_PIXEL_padsize_100.0_box_False_shift_True_sratio_1.0_tratio_1.0_nbclss_2_detection+seoul-pos+softlabel-0.8'
os.system(f"""{base} \
            --padding PIXEL \
            --padding_size 100.0 \
            --use_bbox False \
...
name1 = f'pad_PIXEL_padsize_100.0_box_False_shift_True_sratio_1.0_tratio_1.0_nbclss_2_detection+seoul-pos+softlabel-0.9'
os.system(f"""{base} \
            --padding PIXEL \
            --padding_size 100.0 \
            --use_bbox False \
...
# name2 = f'pad_PIXEL_padsize_100.0_box_False_shift_True_sratio_1.0_tratio_1.0_nbclss_4_detection+seoul-pos-softlabel'
# os.system(f"""{base} \
#             --padding PIXEL \
#             --padding_size 100.0 \
#             --use_bbox False \
