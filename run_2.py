...
name1 = f'pad_PIXEL_padsize_100.0_box_False_shift_True_sratio_0.9_tratio_0.95_nbclss_4'
os.system(f"""{base} \
            --padding PIXEL \
            --padding_size 100.0 \
            --use_bbox False \
...
# name2= f'pad_PIXEL_padsize_100.0_box_False_shift_True_sratio_1_tratio_1_nbclss_4'                       
# os.system(f"""{base} \
#             --padding PIXEL\
#             --padding_size 100.0\
#             --use_bbox False\
